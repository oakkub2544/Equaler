...
class ApiHandler {
  static List<dynamic> checkNullMethod(List<dynamic> data) {
  ...
  static Future<Map> getNewsMethod(List<String> parameter) async {
    ...
    for (var par in parameter) {
      ...
      rawUrl = '$rawUrl&$par'; // rawUrl = Url + page number
    }
    ...
    if (response.statusCode == 200) {
      ...
      Map jsonResponse = json.decode(utf8
          .decode(response.bodyBytes)); //decode response.bodyBytes json to utf8
      checkNullMethod(jsonResponse['results']);
      return jsonResponse;
    }
